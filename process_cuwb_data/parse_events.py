...
def generate_material_events(
    ...
    #     environment_id=environment_id,
    #     environment_name=environment_name,
    #     start=parsed_tray_events['start'].min(),
    #     end=parsed_tray_events['end'].max(),
    #     output_format='dataframe',
    #     chunk_size=chunk_size,
    #     client=client,
    #     uri=uri,
    ...
    # parsed_tray_events['date'] = parsed_tray_events['start'].dt.tz_convert(time_zone).apply(lambda x: x.date())
